...
class ResetPassword : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val inputEmail = view.findViewById<EditText>(R.id.input_reset_email)
        val resetBtn = view.findViewById<Button>(R.id.btn_reset_email)
        ...
        resetBtn.setOnClickListener {
            ...
            {
                MainActivity.auth.sendPasswordResetEmail(emailAddress)
                    .addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            Toast.makeText(this.context, "Email Send, please check your email." , Toast.LENGTH_SHORT).show()
                        }
                        else
                        {
