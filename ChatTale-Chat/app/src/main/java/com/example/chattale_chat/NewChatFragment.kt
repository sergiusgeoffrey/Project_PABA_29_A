...
/**
 * A simple [Fragment] subclass. Use the [NewChatFragment.newInstance] factory method to create an
...
class NewChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // back button
        newChatBackButton.setOnClickListener { findNavController().popBackStack() }
        ...
        createChatroomButton.setOnClickListener {
            ...
            MainActivity.DB
                    ...
                    .addOnSuccessListener {
                        findNavController()
                                .navigate(R.id.action_newChatFragment_to_chattingFragment)
                    }
        }
    }
